...
export const heading = `${typeScale.sectionTitleInverse} mb-5 md:mb-6 md:text-4xl`;
export const description = `mx-auto mb-7 ${typeScale.sectionDescriptionInverse} md:mb-8 md:text-lg`;
