...
export const card = "group relative overflow-hidden rounded-2xl border border-border-default bg-surface p-5 shadow-[0_16px_34px_-28px_color-mix(in_srgb,var(--color-brand-tint)_82%,transparent)] transition-[transform,translate,scale,rotate,box-shadow,border-color] duration-300 hover:-translate-y-0.5 hover:border-brand-tint hover:shadow-[0_26px_56px_-32px_color-mix(in_srgb,var(--color-brand)_34%,transparent)] sm:p-6";
