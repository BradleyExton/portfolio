export const section = "bg-gradient-to-br from-brand to-brand-strong px-4 py-12 text-content-inverse sm:px-6 sm:py-16 md:py-20";
export const container = "mx-auto max-w-5xl text-center";
export const heading = "mb-5 text-2xl font-bold leading-tight sm:text-3xl md:text-4xl font-[family-name:var(--font-space-grotesk)]";
export const description = "mx-auto mb-7 max-w-2xl text-base text-brand-muted md:text-lg";
