...
export const stepBadge = "relative z-10 flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-brand to-brand-strong text-base font-bold text-content-inverse shadow-[0_14px_26px_-18px_rgba(5,150,105,0.95)] ring-4 ring-surface-muted transition-transform duration-300 motion-safe:group-hover:-translate-y-0.5 motion-safe:group-hover:scale-[1.04] sm:h-12 sm:w-12 sm:text-lg";
export const stepContent = "min-w-0 flex-1 pt-0.5";
export const cardTitle = `${typeScale.cardTitle} mb-2`;
export const description = "mb-3 leading-relaxed text-content-muted";
export const output = "inline-block max-w-full rounded-lg border border-border-subtle bg-surface px-3.5 py-2.5 text-sm leading-relaxed text-content-muted shadow-sm";
export const outputLabel = "font-semibold text-brand-strong";
