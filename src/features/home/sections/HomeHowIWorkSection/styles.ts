...
export const stageRail = "mt-2 w-px flex-1 bg-gradient-to-b from-brand-tint via-border-default to-border-default";

export const stageCard = "rounded-2xl border border-border-default bg-surface p-5 shadow-sm transition-[border-color,box-shadow] duration-300 hover:border-brand-tint hover:shadow-md md:p-6 xl:p-7";
