...
export const ctaLink = "group inline-flex h-11 items-center gap-1.5 rounded-lg bg-brand px-5 text-sm font-medium leading-none text-content-inverse transition-[background-color,transform,box-shadow] duration-300 hover:-translate-y-0.5 hover:bg-brand-strong hover:shadow-lg focus-visible:outline-brand";
