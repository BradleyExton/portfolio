...
export const techPill = "rounded-full border border-border-default bg-surface px-4 py-2 text-sm font-medium text-content-muted shadow-sm transition-transform duration-300 hover:-translate-y-0.5";
