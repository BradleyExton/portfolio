...
export const techPill = "inline-flex items-center gap-2 rounded-full border border-border-default bg-surface/85 px-4 py-2 text-sm font-medium text-content-muted shadow-sm backdrop-blur-sm transition-[transform,border-color,box-shadow] duration-300 motion-safe:hover:-translate-y-0.5 hover:border-brand-tint hover:shadow-md";
