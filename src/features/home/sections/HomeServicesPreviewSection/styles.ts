...
export const cardTitle = "mb-1 text-lg font-bold text-content md:mb-2";
...
export const hint = "mb-3 text-xs font-semibold uppercase tracking-[0.11em] text-brand-strong md:mb-4";
