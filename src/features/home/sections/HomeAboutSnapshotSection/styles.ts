...
export const stackedCard = "[--start-range:calc(var(--index0)/var(--numcards)*100%)] [--end-range:calc(var(--index)/var(--numcards)*100%)] [--target-scale:calc(1.1-(0.1*var(--reverse-index)))] h-full origin-top motion-safe:[animation-duration:1ms] motion-safe:[animation-fill-mode:forwards] motion-safe:[animation-name:what-i-do-stack-scale] motion-safe:[animation-range:exit-crossing_var(--start-range)_exit-crossing_var(--end-range)] motion-safe:[animation-timeline:--what-i-do-stack] motion-safe:[animation-timing-function:linear]";
